...
SH
  ...
  assert_contains "$report" "Select the campaign row and confirm the preview shows progress, player count, timestamps, campaign id, save fingerprint, and the full roster"
  assert_contains "$report" "Confirm selected-character icons or badge fallbacks stay compact in the preview"
  ...
  assert_contains "$report" "Select a 4+ player campaign row and confirm the preview shows the full roster without clipping"
